...
// 同期だけのコストの計測
template<bool mode, int kMax, int i>
...
template<bool mode, int kMax, int i, int j, int... Num>
static void func10(sptr<TaskWithStack> task) {
  func10<mode, kMax, i>(task);
  func10<mode, kMax, j, Num...>(task);
}
