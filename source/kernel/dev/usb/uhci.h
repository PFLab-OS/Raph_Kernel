...
private:
  ...
  public:
    ...
    virtual bool GetDeviceDescriptor(UsbCtrl::DeviceDescriptor *desc, int device_addr) override {
      return _dev_uhci->GetDeviceDescriptor(desc, device_addr);
    }
  private:
  ...
  bool GetDeviceDescriptor(UsbCtrl::DeviceDescriptor *desc, int device_addr);
};
